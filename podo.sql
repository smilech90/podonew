...
INSERT INTO TB_MEMBER
VALUES(SEQ_MEMBER_ID.NEXTVAL, DEFAULT, 'test@test.test', '$2a$10$Qniqrgu.rkuttWzD7Opn3eHF.UbcwGEenI2jOANJYIyLd0J7qmW.', 'test', DEFAULT, SYSDATE, SYSDATE, DEFAULT, DEFAULT, 1);
...
VALUES(SEQ_DFILM_ID.NEXTVAL, '이것은 시놉시스', '이것은 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 21, 4);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '감쪽같은그녀 시놉시스', '감쪽같은그녀 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 1);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '안녕베일리 시놉시스', '안녕베일리 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 2);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '기생충 시놉시스', '기생충 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 3);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '녹차의중력 시놉시스', '녹차의중력 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 5);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '어벤져스인피니티워 시놉시스', '어벤져스인피니티워 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 6);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '카메라를 멈추면 안돼 시놉시스', '카메라를 멈추면안돼 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 7);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '세번째살인 시놉시스', '세번째살인 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 8);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '너는여기에없었다 시놉시스', '너는여기에없었다 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 9);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '라라랜드 시놉시스', '라라랜드 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 10);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '너의이름은 시놉시스', '너의이름은 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 11);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '미인어 시놉시스', '미인어 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 12);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '더위치 시놉시스', '더위치 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 13);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '5일의마중 시놉시스', '5일의마중 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 14);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '그랜드부다페스트호텔 시놉시스', '그랜드부다페스트호텔 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 15);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '나이트크롤러 시놉시스', '나이트크롤러 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 16);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '매드맥스 시놉시스', '매드맥스 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 17);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '그녀 시놉시스', '그녀 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 18);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '콜미바이유어네임 시놉시스', '콜미바이유어네임 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 19);
INSERT INTO TB_DETAIL_FILM
VALUES(SEQ_DFILM_ID.NEXTVAL, '미드나잇인파리 시놉시스', '미드나잇인파리 트리비아', 'httpswww.youtube.comwatchv=x60mB0zXZ38', null, DEFAULT, DEFAULT, 1, 20);
...
AS SELECT R., FF.GENRE_ID, FF.RELEASE_YEAR, G.NAME AS NAME
