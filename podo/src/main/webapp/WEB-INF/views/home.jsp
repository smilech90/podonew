	    ...
	    <section>
	      <div class="container">
	        <div class="owl-carousel owl-theme blog-slider">
	          ...
	          <div class="card blog__slide text-center">
	            <div class="blog__slide__img">
	              <img class="card-img rounded-0" src="resources/bootstrap/img/blog/blog-slider/blog-slide2.png" alt="">
	            </div>
	            <div class="blog__slide__content">
	              <a class="blog__slide__label" href="#">Fashion</a>
	              <h3><a href="#">New york fashion week's continued the evolution</a></h3>
	          ...
	          <div class="card blog__slide text-center">
	            <div class="blog__slide__img">
	              <img class="card-img rounded-0" src="resources/bootstrap/img/blog/blog-slider/blog-slide3.png" alt="">
	            </div>
	            <div class="blog__slide__content">
	              <a class="blog__slide__label" href="#">Fashion</a>
	              <h3><a href="#">New york fashion week's continued the evolution</a></h3>
	        ...
	        <div class="row">
	          <div class="col-lg-8">
	            <div class="single-recent-blog-post">
	              <div class="thumb">
	                <img class="img-fluid" src="resources/bootstrap/img/blog/blog1.png" alt="">
	                <ul class="thumb-info">
	            ...
	            <div class="single-recent-blog-post">
	              <div class="thumb">
	                <img class="img-fluid" src="resources/bootstrap/img/blog/blog2.png" alt="">
	                <ul class="thumb-info">
	                  <li><a href="#"><i class="ti-user"></i>Admin</a></li>
	                  <li><a href="#"><i class="ti-notepad"></i>January 12,2019</a></li>
	                  <li><a href="#"><i class="ti-themify-favicon"></i>2 Comments</a></li>
	            ...
	            <div class="single-recent-blog-post">
	              <div class="thumb">
	                <img class="img-fluid" src="resources/bootstrap/img/blog/blog3.png" alt="">
	                <ul class="thumb-info">
	                  <li><a href="#"><i class="ti-user"></i>Admin</a></li>
	                  <li><a href="#"><i class="ti-notepad"></i>January 12,2019</a></li>
	                  <li><a href="#"><i class="ti-themify-favicon"></i>2 Comments</a></li>
	            ...
	            <div class="single-recent-blog-post">
	              <div class="thumb">
	                <img class="img-fluid" src="resources/bootstrap/img/blog/blog4.png" alt="">
	                <ul class="thumb-info">
	                  <li><a href="#"><i class="ti-user"></i>Admin</a></li>
	                  <li><a href="#"><i class="ti-notepad"></i>January 12,2019</a></li>
	                  <li><a href="#"><i class="ti-themify-favicon"></i>2 Comments</a></li>
	                ...
	                <div class="single-sidebar-widget popular-post-widget">
	                  ...
	                  <div class="popular-post-list">
	                    <div class="single-post-list">
	                      <div class="thumb">
	                        <img class="card-img rounded-0" src="resources/bootstrap/img/blog/thumb/thumb1.png" alt="">
	                        <ul class="thumb-info">
	                    ...
	                    <div class="single-post-list">
	                      <div class="thumb">
	                        <img class="card-img rounded-0" src="resources/bootstrap/img/blog/thumb/thumb2.png" alt="">
	                        <ul class="thumb-info">
	                          <li><a href="#">Adam Colinge</a></li>
	                          <li><a href="#">Dec 15</a></li>
	                        </ul>
	                    ...
	                    <div class="single-post-list">
	                      <div class="thumb">
	                        <img class="card-img rounded-0" src="resources/bootstrap/img/blog/thumb/thumb3.png" alt="">
	                        <ul class="thumb-info">
	                          <li><a href="#">Adam Colinge</a></li>
	                          <li><a href="#">Dec 15</a></li>
	                        </ul>
