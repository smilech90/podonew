...
<body>
	...
	<br><br>
	<form action="ninsert.do" method="post" enctype="multipart/form-data" class="noticeInsertForm" id="noticeInsertForm">
		...
		<div class="form-group row">
			...
			<div class="col-sm-4" id="notice-file-area">
				<input type="file" id="notice-upload-file" name="notice-upload-file">
			</div>
		</div>
